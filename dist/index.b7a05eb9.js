...
const router = (0, _vueRouter.createRouter)({
    ...
    routes: [
        {
            path: "/",
            component: ()=>require("eb1b4cde18873006")
        }
    ]
});
...
},{"vue":"gzxs9","./App.vue":"fYNyc","vue-router":"c18b3","eb1b4cde18873006":"1XL1V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gzxs9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
let initialize = ()=>{
    ...
    script.__scopeId = "data-v-99d9e5";
    script.__file = "G:\\node-project\\il4mb.github.io\\src\\App.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "99d9e5-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("99d9e5-hmr", script)) __VUE_HMR_RUNTIME__.reload("99d9e5-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"8a4954974a3e2a08":"evi43","7e9898e9b122e745":"h0MjM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"evi43":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
const _hoisted_1 = {
    class: "bg-gray-800 text-white fixed top-0 w-full z-10"
};
const _hoisted_2 = {
    class: "flex items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-[70px]"
};
...
function render(_ctx, _cache) {
    ...
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)((0, _vue.Fragment), null, [
        (0, _vue.createElementVNode)("nav", _hoisted_1, [
            (0, _vue.createElementVNode)("div", _hoisted_2, [
                ...
                (0, _vue.createElementVNode)("button", {
                    class: "ms-auto text-lg opacity-80 md:hidden w-8 h-8 text-white rounded-sm",
                    onClick: _cache[0] || (_cache[0] = (...args)=>_ctx.triggerMenu && _ctx.triggerMenu(...args))
                }, [
                ...
                (0, _vue.createElementVNode)("div", _hoisted_4, [
                    (0, _vue.createElementVNode)("div", _hoisted_5, [
                        (0, _vue.createElementVNode)("button", {
                            class: "text-xl opacity-80 md:hidden w-8 h-8 text-gray-800 rounded-sm",
                            onClick: _cache[1] || (_cache[1] = (...args)=>_ctx.triggerMenu && _ctx.triggerMenu(...args))
                        }, [
                            (0, _vue.createVNode)(_component_font_awesome_icon, {
                                icon: "times"
                            })
        ...
        (0, _vue.createElementVNode)("main", _hoisted_6, [
            (0, _vue.createVNode)(_component_router_view)
        ])
    ], 64 /* STABLE_FRAGMENT */ );
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("99d9e5-hmr", render);
});
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c18b3":[function(require,module,exports) {
/*!
  * vue-router v4.2.4
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1XL1V":[function(require,module,exports) {
module.exports = require("151751f5440658ba")(require("232ad193eec79a4c").getBundleURL("aNMIV") + "Home.09cfde9d.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("fxTj5"));

},{"151751f5440658ba":"61B45","232ad193eec79a4c":"lgJ39"}],"61B45":[function(require,module,exports) {
"use strict";
...
},{}]},["fUTXd","jeorp"], "jeorp", "parcelRequire8714")
